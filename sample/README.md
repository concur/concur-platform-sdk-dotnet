...
* The UI's **bottom area** displays what a typical app would need from user input in order to submit to the user's company at Concur one expense report with one expense entry and an associated receipt image.  
